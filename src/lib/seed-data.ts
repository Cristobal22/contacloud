...
export const initialChartOfAccounts: Omit<Account, 'id' | 'companyId' | 'balance'>[] = [
    ...
    { code: "1.1", name: "ACTIVO CORRIENTE", type: "Activo" },
    { code: "1.1.01", name: "Efectivo y Equivalentes al Efectivo", type: "Activo" },
    ...
    { code: "1.1.04", name: "Inventarios", type: "Activo" },
    { code: "1.1.04.001", name: "Mercaderías", type: "Activo" },
    { code: "1.1.05", name: "Impuestos Corrientes", type: "Activo" },
    { code: "1.1.05.001", name: "IVA Crédito Fiscal", type: "Activo" },
    { code: "1.1.05.002", name: "PPM por Pagar", type: "Activo" },
    { code: "1.2", name: "ACTIVO NO CORRIENTE", type: "Activo" },
    { code: "1.2.01", name: "Propiedad, Planta y Equipo", type: "Activo" },
    { code: "1.2.01.001", name: "Muebles y Útiles", type: "Activo" },
    { code: "1.2.01.002", name: "Equipos Computacionales", type: "Activo" },
    { code: "1.2.02", name: "Depreciación Acumulada", type: "Activo" },
    { code: "1.2.02.001", name: "Depreciación Acum. Muebles y Útiles", type: "Activo" },
    { code: "1.2.02.002", name: "Depreciación Acum. Equipos Computacionales", type: "Activo" },
    
    // --- 2. PASIVOS ---
    { code: "2", name: "PASIVO", type: "Pasivo" },
    { code: "2.1", name: "PASIVO CORRIENTE", type: "Pasivo" },
    { code: "2.1.01", name: "Cuentas Comerciales y Otras Cuentas por Pagar", type: "Pasivo" },
    { code: "2.1.01.001", name: "Proveedores Nacionales", type: "Pasivo" },
    { code: "2.1.01.002", name: "Honorarios por Pagar", type: "Pasivo" },
    { code: "2.1.02", name: "Cuentas por Pagar a Entidades Relacionadas", type: "Pasivo" },
    { code: "2.1.03", name: "Impuestos Corrientes", type: "Pasivo" },
    { code: "2.1.03.001", name: "IVA Débito Fiscal", type: "Pasivo" },
    { code: "2.1.03.002", name: "Retención Impuesto Único 2da Categoría", type: "Pasivo" },
    { code: "2.1.03.003", name: "Retención Impuesto Adicional", type: "Pasivo" },
    { code: "2.1.04", name: "Provisiones Corrientes", type: "Pasivo" },
    { code: "2.1.04.001", name: "Provisión Gratificaciones", type: "Pasivo" },
    { code: "2.1.05", name: "Obligaciones con Empleados y Provisiones", type: "Pasivo" },
    { code: "2.1.05.001", name: "Remuneraciones por Pagar", type: "Pasivo" },
    { code: "2.1.05.002", name: "Leyes Sociales por Pagar", type: "Pasivo" },
    { code: "2.2", name: "PASIVO NO CORRIENTE", type: "Pasivo" },
    { code: "2.2.01", name: "Obligaciones Financieras a Largo Plazo", type: "Pasivo" },

    // --- 3. PATRIMONIO ---
    { code: "3", name: "PATRIMONIO", type: "Patrimonio" },
    { code: "3.1", name: "CAPITAL", type: "Patrimonio" },
    { code: "3.1.01", name: "Capital Pagado", type: "Patrimonio" },
    { code: "3.2", name: "RESULTADOS ACUMULADOS", type: "Patrimonio" },
    { code: "3.2.01", name: "Resultados Acumulados", type: "Patrimonio" },
    { code: "3.3", name: "RESULTADO DEL EJERCICIO", type: "Patrimonio" },
    { code: "3.3.01", name: "Resultado del Ejercicio", type: "Patrimonio" },

    // --- 4. INGRESOS (RESULTADO) ---
    { code: "4", name: "INGRESOS", type: "Resultado" },
    { code: "4.1", name: "INGRESOS DE ACTIVIDADES ORDINARIAS", type: "Resultado" },
    { code: "4.1.01", name: "Venta de Bienes", type: "Resultado" },
    { code: "4.1.02", name: "Prestación de Servicios", type: "Resultado" },
    { code: "4.2", name: "OTROS INGRESOS", type: "Resultado" },
    { code: "4.2.01", name: "Ingresos Financieros", type: "Resultado" },

    // --- 5. COSTOS (RESULTADO) ---
    { code: "5", name: "COSTOS DE VENTA", type: "Resultado" },
    { code: "5.1", name: "COSTO DE VENTAS", type: "Resultado" },
    { code: "5.1.01", name: "Costo de Mercaderías Vendidas", type: "Resultado" },

    // --- 6. GASTOS (RESULTADO) ---
    { code: "6", name: "GASTOS", type: "Resultado" },
    { code: "6.1", name: "GASTOS DE ADMINISTRACIÓN", type: "Resultado" },
    { code: "6.1.01", name: "Remuneraciones", type: "Resultado" },
    { code: "6.1.02", name: "Honorarios", type: "Resultado" },
    { code: "6.1.03", name: "Arriendos", type: "Resultado" },
    { code: "6.1.04", name: "Suministros Básicos", type: "Resultado" },
    { code: "6.1.05", name: "Depreciación", type: "Resultado" },
    { code: "6.2", name: "GASTOS DE VENTA", type: "Resultado" },
    { code: "6.2.01", name: "Publicidad y Marketing", type: "Resultado" },
    { code: "6.3", name: "GASTOS FINANCIEROS", type: "Resultado" },
    { code: "6.3.01", name: "Intereses Bancarios", type: "Resultado" },
];
